...
modMask' = mod4Mask
-- Define workspaces
myWorkspaces    = ["1:main","2:web","3:debug","4:chat","5:music", "6:gimp", "7:misc"]
-- Dzen/Conky
-- myXmonadBar = "dzen2 -x '0' -y '0' -h '20' -w '99999999900' -ta 'l' -fg '#FFFFFF' -bg '#1B1D1E'"
-- myStatusBar = "conky -c /home/tduong/.xmonad/.conky_dzen | dzen2 -x '2080' -w '1040' -h '18' -ta 'r' -bg '#1B1D1E' -fg '#FFFFFF' -y '0'"
-- myBitmapsDir = "/home/tduong/.xmonad/dzen2"
--}}}
-- Main {{{
main = do
